...
async function loadData() {
    try {
        // 1. (ทางเลือก) โหลดไฟล์สำหรับ "จำลองสอบ" หรือ "ทดลองฟรี" เตรียมไว้ก่อน
        // เพราะไฟล์พวกนี้มักจะมีขนาดเล็ก (10-40 ข้อ) โหลดทิ้งไว้ได้เลยไม่หนักเครื่อง
...
async function showExamSets(mode) {
    ...
    const fileMap = {
        ...
        "ข้อสอบเสมือนจริงปี 2567": "mock_2567.json"
    };
